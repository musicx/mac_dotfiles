...
# added for edge servers
#export TMP="/rdata1/yijiliu/tmp"
#export THEANO_FLAGS=blas.ldflags="-L/usr/local/risk/old/linux/lib64/atlas -lf77blas"

# added for deep learning server
#export PYLEARN2_DATA_PATH=$HOME/deeplearning/data
#export PATH=/usr/local/cuda-5.5/bin:$PATH:$HOME/deeplearning/pylearn2/scripts
#export LD_LIBRARY_PATH=/usr/local/cuda-5.5/lib64:$LD_LIBRARY_PATH
#export THEANO_FLAGS=device=gpu

# added for sas server
#alias td='~/bin/run_td_query.ksh'
#alias p='ps -Af | grep yijiliu'
#export PATH=$HOME/bin:$HOME/.local/bin:$PATH
#export LD_LIBRARY_PATH=$HOME/lib:$LD_LIBRARY_PATH
#export PYTHONPATH=$PYTHONPATH:$HOME/lib/python
#export BLAS=$HOME/lib/libfblas.a
#export LAPACK=$HOME/lib/liblapack.a

# within RAE
#alias sshsas2='ssh -i ~/.ssh/rae_rsa yijiliu@phxaidisas02.phx.paypal.com'
